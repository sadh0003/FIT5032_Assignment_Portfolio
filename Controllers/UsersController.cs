...
namespace FIT5032_Assignment_Portfolio.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,Password,FirstName,LastName,Email,Mobile,UserTypeId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password,FirstName,LastName,Email,Mobile,UserTypeId")] User user)
        {
            if (ModelState.IsValid)
            {
